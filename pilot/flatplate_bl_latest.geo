...
Point(9) = {bl_length, (plate_width/2), 0, 0.1};
Point(10) = {bl_length, -(plate_width/2), 0, 0.1};
...
Point(15) = {-bl_length, -(plate_width/2), 0, 0.1};
Point(16) = {-bl_length, (plate_width/2), 0, 0.1};
...
Transfinite Line {16,18,19,-8,-14,23,22,10} = chord_ortho Using Progression 1.03;
Transfinite Line {-17,-24,-20,-21,-5,7,13,-11} = chord_factor Using Progression 1.01;
Transfinite Line {27,25,9,15} = 2; // // Using Bump 0.1;
Transfinite Line {6,26,28,12} = chord_factor Using Bump 0.4;
